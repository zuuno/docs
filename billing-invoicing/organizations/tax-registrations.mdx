...
```bash
# Create organization
curl https://api.nocotax.app/v1/organizations \
...
curl https://api.nocotax.app/v1/tax_registrations \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -d '{
    "organization_id": "org_created_above",
    "country": "DE",
...
curl https://api.nocotax.app/v1/tax_registrations \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -d '{
    "organization_id": "org_seller_created",
    "country": "FR",
...
curl https://api.nocotax.app/v1/tax_registrations \
  -H "Authorization: Bearer YOUR_API_KEY" \
  -d '{
    "organization_id": "org_supplier_created",
    "country": "NL",
