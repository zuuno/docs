...
![Tax Onboarding](/images/tax-onboarding.png)
...
![New Tax Registration](/images/new-tax-registration.png)
...
<Columns cols={2}>
  <Card title="EU tax registration types" icon="map" href="/taxes/registrations/eu-types">
    
  </Card>
  <Card title="Tax registration types per country" icon="globe" href="/taxes/registrations/eu-types">
...
<AccordionGroup>
  <Accordion title="Scenario 1: EU business selling B2C across Europe">
  ...
  <Accordion title="Scenario 2: Non-EU business selling digital services">
  ...
  <Accordion title="Scenario 3: E-commerce marketplace shipping from China">
  ...
  <Accordion title="Scenario 4: Small EU seller under threshold">
