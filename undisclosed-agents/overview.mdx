...
[View customer invoicing guide →](/undisclosed-agent/customer-invoicing)
...
[View self-billing guide →](/undisclosed-agent/self-billing)
...
<CardGroup cols={2}>
  ...
  <Card title="Self-Billing" icon="file-invoice-dollar" href="/undisclosed-agent/self-billing">
